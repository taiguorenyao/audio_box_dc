...
<body style="background-image: url('/static/images/sys_wap_bg.jpg');background-attachment: fixed;background-repeat: no-repeat;background-size: cover;">
<div class="container">
    <div class="line">
        <div class="xs6 xm4 xs3-move xm4-move">
            ...
            <br /><br />
            <form action="/syswap/syslogindo" id="loginForm" method="post">
                <div class="panel">
