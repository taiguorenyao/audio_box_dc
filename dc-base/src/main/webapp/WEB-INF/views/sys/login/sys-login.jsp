...
<body style="background-image: url('/static/images/sys_login_bg.jpg');background-attachment: fixed;background-repeat: no-repeat;background-size: cover;">
<div class="container">
    <div class="line">
        <div class="xs6 xm4 xs3-move xm4-move">
            <br /><br />
            <div class="media media-y">
                <a href="http://www.pintuer.com" target="_blank"><img style="width:100%" src="/static/logo/logo.png" class="radius" alt="后台管理系统" /></a>
            </div>
            <br /><br />
            <form action="/login/syslogindo" id="loginForm" method="post">
                <div class="panel">
                    <div class="panel-head"><strong>后台系统</strong><span style="font-size:18px;color: red">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;${errorCode}</span></div>
                    ...
                    <div class="panel-foot text-center"><button class="button button-block bg-main text-big">就是干</button></div>
                </div>
            </form>
