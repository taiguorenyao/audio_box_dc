...
<div class="admin">
    <div class="tab">
        <div class="tab-head">
            <ul class="tab-nav">
                <li class="active"><a href="#tab-set">增加配置</a></li>
        ...
        <div class="tab-body">
            ...
            <div class="tab-panel active" id="tab-set">
                <form method="post" class="form-x" action="/sys/addConfigdo">
                    <div class="form-group">
                        <div class="label"><label>KEY</label></div>
                        <div class="field">
                            <input type="text" class="input input-auto"  name="key"  placeholder="请输入KEY" data-validate="required:请输入KEY"  />
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="field">
                            <input type="text" class="input input-auto" name="value"   size="66" placeholder="请输入VALUE" data-validate="required:请输入VALUE"  />
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="field">
                            <input type="text" class="input input-auto" name="description"   size="66" placeholder="请输入描述" data-validate="required:请输入描述"  />
                        </div>
                    </div>
