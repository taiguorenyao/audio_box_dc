...
<script type="text/javascript">
    $('.portal-all_menu li').each(function () {
        ...
        document.getElementById("menu-domain").className = "active";
    });
</script>
<div class="admin">
    <form method="post" action="/sys/domainlist" id="queryPage"
          name="queryPage">
        <input type="hidden" id="beginPage" name="curPage" value="${curPage}"/>
        <div class="panel admin-panel">
            <div class="panel-head"><strong>域名管理</strong></div>
            <div class="padding border-bottom">
                <a href="/sys/addDomain">
                    <input type="button"
...
<script type="text/javascript">
    ...
    function subInput()
    {
        ...
        window.location.href="/sys/refreshDomain/"+vals;
    }
    ...
    function　delallData()
    {
        ...
        window.location.href="/sys/deldomains?id="+vals;
    }
